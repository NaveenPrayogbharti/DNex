...
const megaMenuConfig: Record<string, MegaMenuConfig> = {
  ...
  "India Services": {
    ...
    featured: {
      ...
      desc: "Seamlessly bridging the UAE and India through specialized services in FEMA compliance, NRI banking, company incorporation, income tax, GST, ROC compliance, and end-to-end legal support across both jurisdictions.",
